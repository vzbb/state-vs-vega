...
const MedicalSection: React.FC<MedicalSectionProps> = ({ setView }) => {
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 animate-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="glass-panel p-8 rounded-xl border border-rose-900/30 hover:border-rose-900/60 transition-colors duration-300">
        <h3 className="text-2xl font-bold text-white mb-6 text-center">The Carceral Death Spiral</h3>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            <div className="p-4 bg-zinc-900 rounded-lg group hover:bg-zinc-800 transition-colors">
                <div className="text-rose-500 font-bold text-lg mb-2">1. Environment</div>
                <p className="text-xs text-zinc-400">Uneven floors + Triple Amputee (No balance/arms) = Inevitable Fall.</p>
            </div>
            <div className="hidden md:flex items-center justify-center text-zinc-600">→</div>
            <div className="p-4 bg-zinc-900 rounded-lg group hover:bg-zinc-800 transition-colors">
                <div className="text-rose-500 font-bold text-lg mb-2">2. Fracture</div>
                <p className="text-xs text-zinc-400">Protruding implant tears skin. Open Periprosthetic Fracture.</p>
            </div>
            <div className="hidden md:flex items-center justify-center text-zinc-600">→</div>
            <div className="p-4 bg-zinc-900 rounded-lg group hover:bg-zinc-800 transition-colors">
                <div className="text-rose-500 font-bold text-lg mb-2">3. Sepsis</div>
                <p className="text-xs text-zinc-400">Biofilm infection. Fulminant Sepsis. Massive Hemorrhage.</p>
            </div>
            <div className="hidden md:flex items-center justify-center text-zinc-600">→</div>
            <div className="p-4 bg-zinc-900 rounded-lg border border-rose-600/50 group hover:border-rose-500 hover:bg-rose-950/10 transition-all">
                <div className="text-rose-500 font-bold text-lg mb-2">4. Fatality</div>
                <p className="text-xs text-zinc-400">Prison response times cannot manage complex orthopedic salvage.</p>
            </div>
        </div>
      </div>
    </div>
